import type { PostCategory } from '@pages/myPage/types/myPage';
...
const PostCard = ({
  ...
  return (
    ...
    >
      <span className="label-1-m inline-flex h-[2.1rem] w-[3.8rem] items-center justify-center whitespace-nowrap rounded-[1.6rem] border border-primary bg-primary-light px-[1rem] text-primary">
        {CATEGORY_LABEL[category]}
      </span>
      <p className="text-1-m w-[31.1rem] truncate px-[0.8rem] text-gray-900">
        {content}
      </p>
